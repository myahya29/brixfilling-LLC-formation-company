...
*/
function createMemoryHistory$1(opts = { initialEntries: ["/"] }) {
...
//#endregion
export { parseHref$1 as i, createBrowserHistory as n, createMemoryHistory$1 as r, createMemoryHistory as t };
